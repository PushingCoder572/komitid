...
def sl_search(start, dest):
    # https://api.sl.se/api2/typeahead.json?key=9af74c05d3464ed3b18fa132c9b41726&searchstring=&stationsonly=True&maxresults=1'
...
def sl_get_trip(origin_id, dest_id, dest_time, dest_date_offset=1):
    today = date.today()
    tomorrow = today + timedelta(days=dest_date_offset)

    d1 = tomorrow.strftime("%Y-%m-%d")
    # http://api.sl.se/api2/TravelplannerV3_1/trip.json?key=6828b3e5b4b04737b4311891e825e913&originId=9115&destId=9668&Date=2020-09-04&Time=09:00&searchForArrival=1
...
print(sl_search('fridemsplan', 'galoppfältet'))
